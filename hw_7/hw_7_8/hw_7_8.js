...
console.log(`${youngestCinderellaWife.name} and ${princeHasband.name} ---"Girko!!!"`);
let cinderellaWifeFind = cinderellas.find((item) => item.shoeSize === princeHasband.shoesFound);
if (cinderellaWifeFind) {
    console.log("cinderellaWifeFind :", cinderellaWifeFind);
    console.log(`${cinderellaWifeFind.name} and ${princeHasband.name} ---"Girko!!!"`);
}
else {
