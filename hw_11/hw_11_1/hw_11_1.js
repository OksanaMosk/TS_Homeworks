...
const list111 = document.createElement("ul");
...
fetch("https://dummyjson.com/carts")
    ...
    for (const cart of carts) {
        ...
        for (const itemProduct of products) {
            ...
            productTotal.innerText = `Total: $${parseFloat(itemProduct.total.toFixed(2))}`;
            ...
            productItem.append(productTitle, productImg, productPrice, productQuantity, productTotal, productDiscount, productDiscountedTotal);
        }
    }
});
